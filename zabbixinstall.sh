...
sed -i "s+Server=127.0.0.1+Server=10.11.12.12+g" /etc/zabbix/zabbix_agentd.conf
sed -i "s+ServerActive=127.0.0.1+ServerActive=10.11.12.12:10051+g" /etc/zabbix/zabbix_agentd.conf
